                ...
                <form method="post" action="{{ route('ImportProductOrder.store') }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="id_product" id="id_product" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                            @error('id_product')
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="number" name="cost" id="cost" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                            @error('cost')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="date" name="date_EXP" id="date_EXP" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                            @error('date_EXP')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
